...
## Overview
Presents a symbol picker that allows the user to select a custom image and a color, which are synchronized with the provided bindings. This overload specifically uses `CKColor` for precise color management. The image binding is optional.
