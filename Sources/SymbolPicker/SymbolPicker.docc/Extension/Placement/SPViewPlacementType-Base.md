...
The `SPInsetedView/Placement` enum specifies where an ``SymbolPicker/SPInsetedView`` will be rendered. These placements range from standard safe areas to platform-specific toolbar locations.
