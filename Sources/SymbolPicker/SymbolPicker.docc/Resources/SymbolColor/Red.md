...
A vibrant red color for symbols.

## Overview

The red color has RGB values [0.906, 0.392, 0.416] and is useful for highlighting important symbols or indicating alerts and warnings.
